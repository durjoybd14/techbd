...
const TelevisionDetails = (props) => {
  const { img, price, name, screen, display, port } = props.televisionData;
  return (
    <div className="lg:w-1/3 md:w-1/2 p-5 w-full shadow-lg border text-center my-5">
      ...
      <div className="mt-5">
        ...
        <h3 className="text-gray-500 text-xs tracking-widest title-font mb-3 flex  items-center">
          <TiTick style={{ fontSize: "20px" }} /> {screen}
        </h3>
        <h3 className="text-gray-500 text-xs tracking-widest title-font mb-3 flex  items-center">
          <TiTick style={{ fontSize: "20px" }} /> {display}
        </h3>
        <h3 className="text-gray-500 text-xs tracking-widest title-font mb-3 flex  items-center">
          <TiTick style={{ fontSize: "20px" }} /> {port}
        </h3>
